...
import com.example.howlong.ParkingBookTwo.LoadUrl;
...
public class ParkingBookTwo extends Activity {
	...
	String url="http://ambesttechnologies.com/ParkingManagement/storetwo.php";
	ProgressDialog pd;
	@Override
...
Intent i=getIntent();
        ...
        a.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(n.equals("")||u.equals("")||p.equals("")||e.equals("")||m.equals("")){
					Toast.makeText(ParkingBookTwo.this, "Pls fill the fields", Toast.LENGTH_LONG).show();
				}else{
	...
	public class LoadUrl extends AsyncTask<String, String, String>
	{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pd=new ProgressDialog(ParkingBookTwo.this);
			...
			try {
				...
				runOnUiThread( new Runnable() {
					public void run() {
						if(s==1)
						{
						Toast.makeText(ParkingBookTwo.this, "Slot Booked Successfully", Toast.LENGTH_SHORT).show();
						n.setText("");
						u.setText("");
						p.setText("");
						...
						Intent i=new Intent(ParkingBookTwo.this, TwoWheeler.class);
						startActivity(i);
						}
						else
						{
							Toast.makeText(ParkingBookTwo.this, "Failed to Created", Toast.LENGTH_SHORT).show();
							n.setText("");
							u.setText("");
							p.setText("");
